    ...
    <section className="w-full bg-[#FBF9E8] px-8 py-8 md:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-800 mb-8">
          {/* Column 1 */}
          <div>
            <h3 className="font-semibold text-lg text-[20px] mb-3 border-b-2 border-black inline-block">গুরুত্বপূর্ণ তথ্য</h3>
          ...
          {/* Column 2 */}
          <div>
            <h3 className="font-semibold text-lg text-[20px] mb-3 border-b-2 border-black inline-block">আমাদের প্রতিশ্রুতি</h3>
            <p className="text-sm leading-relaxed text-[20px] max-w-xl">
          ...
          {/* Column 3 */}
          <div>
            <h3 className="font-semibold text-lg md:text-[20px] mb-3  border-b-2 border-black inline-block">পরিকল্পনা</h3>
            <p className="text-sm leading-relaxed text-[20px] max-w-xl">
        ...
        <p className="text-center text-sm md:text-[20px] text-gray-700">
         <span className="text-[#018635]">© ২০২৫</span>  — আপনার নাম | সর্বস্ব সংরক্ষিত
        </p>
      </div>
    </section>
  );
