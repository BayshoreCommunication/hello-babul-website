...
const UrgentComplaint = () => {
  ...
  // Fetch urgent suggestions (ALL types except "general")
  useEffect(() => {
    let mounted = true;
    ...
    async function fetchData() {
      try {
        ...
        console.log("Fetching urgent suggestions...");
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        console.log("Deleted emergency suggestion:", selectedItem.fullname);
        setOpen(false);
      ...
      <div className="bg-white rounded-lg shadow-sm p-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500">
            <p>কোন জরুরি পরামর্শ পাওয়া যায়নি</p>
          </div>
        ) : (
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item._id} className="border-b border-gray-100">
                  ...
                  <td className="py-4 text-red-700 font-semibold">
                    {item.typeOfSuggest}
                  </td>
                  <td className="py-4">
                    <span
                  ...
                  <td className="py-4 text-center space-x-3">
                    <button
                      ...
                      onClick={() => {
                        ...
                        window.location.href = `/dashboard/complaints/${item._id}`;
                      }}
                    >
                      <LuEye size={16} />
                    </button>
        ...
        <DeleteModal
          ...
          confirmMessage={`আপনি কি নিশ্চিত "${selectedItem?.fullname}" এর জরুরি পরামর্শটি মুছে ফেলতে চান?`}
        />
      </div>
    </div>
  );
